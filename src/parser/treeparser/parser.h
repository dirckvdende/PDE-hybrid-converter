...
public:
     ...
     */
    TreeParser(const std::vector<TreeToken> &tokens);
...
private:
     ...
     */
    bool accept(TreeTokenType type) const;
     ...
     * @param type The type to match with
     */
    void expect(TreeTokenType type);
    ...
    const std::vector<TreeToken> &tokens;
